...
<xsl:text>              type: </xsl:text><xsl:value-of select="."/><xsl:text>
</xsl:text>
</xsl:template>

<xsl:template match="ref">
<xsl:text>              $ref: '#/definitions/</xsl:text><xsl:value-of select="."/>'<xsl:text>
</xsl:text>
</xsl:template>
...
<xsl:text>      </xsl:text><xsl:value-of select="@name"/>:
<xsl:apply-templates select="type" mode="min"/>
<xsl:apply-templates select="ref" mode="min"/>
</xsl:template>


<xsl:template match="type" mode="min">
<xsl:text>        type: </xsl:text><xsl:value-of select="."/><xsl:text>
</xsl:text>
</xsl:template>

<xsl:template match="ref" mode="min">
<xsl:text>        $ref: '#/definitions/</xsl:text><xsl:value-of select="."/>'<xsl:text>
</xsl:text>
</xsl:template>
